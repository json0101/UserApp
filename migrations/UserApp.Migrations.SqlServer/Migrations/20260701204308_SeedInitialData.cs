...
namespace UserApp.Migrations.SqlServer.Migrations
{
    /// <inheritdoc />
    public partial class SeedInitialData : Migration
    {
        // Datos semilla iniciales (equivalente a InitRecord de Postgres): aplicacion, acciones,
        // rol Administrador, pantallas base y el usuario administrador por defecto.
        /// <inheritdoc />
        ...
        {
            migrationBuilder.Sql("delete from sec.users_applications;");
            migrationBuilder.Sql("delete from sec.roles_screens;");
            migrationBuilder.Sql("delete from sec.screens_actions;");
            migrationBuilder.Sql("delete from sec.users_roles;");
